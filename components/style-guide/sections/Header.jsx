...
function Header() {
  return (
    <div className="block">
      ...
      <h1 className='text-center text-[1.3rem] md:text-[2.28rem] font-mokotoGlitch  opacity-70 mt-0 md:-mt-20 mb-8' style={{
  "textShadow": "0.05em 0 0 rgb(255,0,0,0.75), -0.025em -.05em 0 rgb(0,255,0,0.75), -0.025em 0.05em 0 rgb(0,0,255,0.75)"
