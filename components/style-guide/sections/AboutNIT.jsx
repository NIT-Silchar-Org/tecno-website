    ...
    return (
        <div class="h-screen w-screen flex flex-col justify-center items-center bg-black text-white">
            <div className='w-[60vw] text-center'>
                <h1 className='text-[3rem] mb-[2rem] tracking-wider font-light font-lemonMilk'>ABOUT NIT SILCHAR</h1>
                <p className='text-[1.25rem] mb-[1.5rem] uppercase leading-10'>
                ...
                <button className=' uppercase text-[1.25rem] border border-white p-[1rem]'>Download Bronchure</button>
            </div>
